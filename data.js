// Page wording and settings. Plain text only; no HTML.
const SITE = {
  ...
  intro:
    "Every application portal, aid form, scholarship and handout your counselors actually use — plus your youth leaders and our monthly newsletters. One page, always current.",
  pageTitle: "College Office Hub — A. Philip Randolph Campus High School",
  schoolName: "A. Philip Randolph Campus High School",
  logo: "logo.png",
  email: "cgoris@aprandolph.com",
  searchPlaceholder: "Search FAFSA, CUNY, a youth leader…",
  comingSoon: "Coming Soon",
  photoPlaceholder: "Photo goes here",
  youthHeading: "Meet Your Youth Leaders",
  youthCount: "youth leaders · here to help",
  youthIntroStart: "Not sure who yours is? Find your last name in the ",
  assignedLabel: "Assigned to",
  youthIntroEnd: " row below, or stop by the office and we'll match you.",
  staffHeading: "Meet Your SSC Staff",
  staffCount: "adult staff · Room 214",
  freeLabel: "Free periods",
  workingLabel: "Working",
  whereLabel: "Where",
  hoursLabel: "Hours",
  aboutLabel: "Ask about",
  noResults: "Nothing matched",
  searchHelp: 'Try "FAFSA", "SUNY", or stop by the College Office in Room 214.',
};

// Resource section headings. Order/layout is defined in app.js render().
const SECTION_COPY = {
  applying: {
    title: "Applying to College",
    subtitle: "CUNY · SUNY · Common App",
  },
  pathways: {
    title: "Trade & Armed Forces",
    subtitle: "Other post-secondary paths",
  },
  financialAid: {
    title: "Financial Aid",
    subtitle: "FAFSA first, always",
  },
  scholarships: {
    title: "Scholarships",
    subtitle: "Money you never repay",
  },
  guides: {
  ...
  social: {
    title: "Hear From Us",
    subtitle: "Announcements live here",
  },
  newsletters: {
...
/* ═══════════════════════════════════════════════════════════════════════
   ...
   CONTENT AND PAGE WORDING LIVE HERE. See AGENTS.md for layout and behavior edits.

   Open this repository in your AI coding tool and describe the change.
   Example prompts:
